...
(() => {
  ...
  function servicesHorizontalScroll() {
    const mm = gsapWithCSS.matchMedia();
    mm.add("(min-width: 992px)", () => {
      const sections = gsapWithCSS.utils.toArray(".home-hz-solution-wrap");
      gsapWithCSS.to(sections, {
        ...
        scrollTrigger: {
          ...
          start: "-=71",
          end: () => "+=" + document.querySelector(".section_home-solutions").offsetWidth
        }
      });
    });
  }
  function articlesAnim() {
    const articles = gsapWithCSS.utils.toArray(".is-news");
