...
(() => {
  ...
  // node_modules/.pnpm/lenis@1.1.2/node_modules/lenis/dist/lenis.mjs
  function clamp3(t2, e, i) {
  ...
  var Animate = class {
    advance(t2) {
      ...
      let e = false;
      if (this.lerp)
        this.value = function damp(t3, e2, i, s) {
        ...
        this.currentTime += t2;
        const i = clamp3(0, this.currentTime / this.duration, 1);
        e = i >= 1;
  ...
  var Lenis = class {
    ...
    scrollTo(t2, { offset: e = 0, immediate: i = false, lock: s = false, duration: o = this.options.duration, easing: n = this.options.easing, lerp: r = !o && this.options.lerp, onStart: l, onComplete: h, force: a = false, programmatic: c = true, userData: u = {} } = {}) {
      if (!this.isStopped && !this.isLocked || a) {
        ...
        if ("number" == typeof t2) {
          if (t2 += e, t2 = Math.round(t2), this.options.infinite ? c && (this.targetScroll = this.animatedScroll = this.scroll) : t2 = clamp3(0, t2, this.limit), i)
